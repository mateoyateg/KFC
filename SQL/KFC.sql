...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-10-2021 a las 00:51:15
...
(15, 51, 'Wow Box Duo', '2 Sándwiches BBQ Crunch (c/u 1 Filete de pollo apanado) + 1 Pop Corn Pequeño (Trocitos de pechuga de pollo apanados) + 4 Alitas Picantes (Las alitas picantes hot wings equivalen a un trozo de ala) + 2 Papa Pequeña + 2 Gase', 29900, 'wowbox-duo.png'),
...
(48, 31, 'Mega Recargado', 2, '62900.00', NULL, '2021-10-09 22:50:57');
...
--
ALTER TABLE `users_orders`
  MODIFY `o_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
COMMIT;
