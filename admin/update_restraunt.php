...
if(isset($_POST['submit']))           //cuando el boton de adtualizar es presionado
{
	...
	else
		{
				...
				$fname = $_FILES['file']['name'];
								...
								$store = "Res_img/".basename($fnew);                      // la ruta para almacenar la imagen cargada
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>El tamaño máximo de la imagen debe ser de 1024kb!</strong> Intente con otra imagen.
															</div>';
					...
					elseif($extension == '')
					{
						$error = 	'<div class="alert alert-danger alert-dismissible fade show">
											...
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Extensión invalida</strong> solo se aceptan png, jpg, Gif.
															</div>';
        ...
        <div class="page-wrapper" style="height:1200px;">
            ...
            <div class="container-fluid">
                        ...
                        <div class="card card-outline-primary">
                                ...
                                <h4 class="m-b-0 ">Actualizar el restaurante</h4>
