...
if(isset($_POST['submit']))           //si el bóton es presionado
{
		...
		{	
											$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																...
																<strong>Todos los campos son requerido</strong>
															</div>';
									...
									if($fsize>=1000000)
										{
												...
												$error = 	'<div class="alert alert-danger alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>El peso máximo de la imagen debe ser de 1024kb</strong> Try different Image.
															</div>';
									...
									else
										{
												...
												move_uploaded_file($temp, $store);
													...
													$success = 	'<div class="alert alert-success alert-dismissible fade show">
																<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
																<strong>Registro</strong> Actualizado.
															</div>';
            ...
            <div class="container-fluid">                
                        ...
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Agregar menú al restaurante</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
											 ...
											 <div class="col-md-12">
                                                <div class="form-group">
													...
													<select name="res_name" class="form-control custom-select" data-placeholder="seleccione una categoria" tabindex="1">
