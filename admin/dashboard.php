                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item hidden-sm-down search-box"> <a class="nav-link hidden-sm-down text-muted  " href="javascript:void(0)"><i class="ti-search"></i></a>
                            <form class="app-search">
                                <input type="text" class="form-control" placeholder="Buscar aquí"> <a class="srh-btn"><i class="ti-close"></i></a> </form>
                        </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated zoomIn">
                                <ul>
                                    ...
                                    <li>
                                        <a class="nav-link text-center" href="javascript:void(0);"> <strong>Comprobar todas las notificaciones</strong> <i class="fa fa-angle-right"></i> </a>
                                    </li>
                                </ul>
                            </div>
                        </li>
